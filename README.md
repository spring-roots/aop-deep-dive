...
However, the ceremony involved in creating the proxies feels like boilerplate.  Indeed, the Application Context can be configured to generate proxies automatically.
